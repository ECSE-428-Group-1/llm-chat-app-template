...
import { updateAndSetToken, getSessionToken, hasSessionToken } from "./session.js";
import { addMessageToChat, showTypingIndicator, hideTypingIndicator, clearErrorBubble, createAssistantMessageElement, scrollToBottom } from "./ui.js";
...
export async function sendMessage(isRetry = false, retryQuestion = null) {
    ...
    try {
        ...
        await processStreamResponse(response, assistantMessageEl, assistantTextEl, message);
    } catch (error) {
...
async function processStreamResponse(response, assistantMessageEl, assistantTextEl, originalMessage) {
